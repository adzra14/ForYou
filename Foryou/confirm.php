...
<html lang="en">
    ...
    <body>
        ...
        <div class="login">
            <h1 class="header1 display-1 mb-5">hey? who are you?!</h1>
            <h2 class="header1 display-4 mb-5">how can u get here -_-</h2>
            <h class="header1 display-4 mb-5">how can u get here -_-</h>
                <form class="header1 ">
                <input class="input-lg mb-3 col-3" id="inputlg" type="text"><br>
                    <button class="btn btn-primary display-6" type="button">Confirm</button>
                </form>
        </div>
        </div>
